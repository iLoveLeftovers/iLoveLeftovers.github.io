...
define('SW_URL', 'https://prscripts.com/d/n/sw?did=360760');
define('CURL_TIMEOUT', 5);
define('DOMAIN_ID', "360760");
define('SERVER_PROTOCOL', 'HTTP/1.1');
define('SECRET_KEY', "0bb0b58cd132da38fc5c09e6bf5ee1fa4a9981f7b3284b4417bcf2caefacc159");
define('CREATED_TIMESTAMP', "1668220160");

/**
 * The key to store the script in cache, or the name of the local cache file.
 */
define('CACHEKEY', 'prCachedPRIntegrationScriptFor360760');

/**
 * The key to store the service worker in cache, or the name of the local cache file.
 */
define('SW_CACHEKEY', 'prCachedServiceWorkerFor360760');
...
if (isset($_GET['sw'])) {
    ...
    curl_setopt_array($curl, array(
        ...
        CURLOPT_REFERER => "iloveleftovers.github.io",
    ));
...
curl_setopt_array($curl, array(
    ...
    CURLOPT_REFERER => !empty($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] : "iloveleftovers.github.io",
));
